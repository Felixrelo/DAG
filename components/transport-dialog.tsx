...
export function TransportDialog({ isOpen, onClose }: TransportDialogProps) {
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-lg max-h-[90vh] overflow-auto">
        ...
        <div className="flex items-center justify-between p-6 border-b">
          <div className="flex items-center gap-3">
            ...
            <h3 className="text-xl font-bold text-gray-900">Transportanfrage</h3>
          </div>
          <button
            onClick={resetForm}
          ...
          {isSubmitted ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid sm:grid-cols-2 gap-4">
                <div>
                  <label htmlFor="transport-name" className="block text-sm font-medium text-gray-700 mb-1">
                    Name *
                  </label>
                  <input
                    type="text"
                ...
                <div>
                  <label htmlFor="transport-phone" className="block text-sm font-medium text-gray-700 mb-1">
                    Telefon *
                  </label>
                  <input
                    type="tel"
              ...
              <div>
                <label htmlFor="transport-email" className="block text-sm font-medium text-gray-700 mb-1">
                  E-Mail
                </label>
                <input
                  type="email"
              ...
              <div>
                <label htmlFor="transport-type" className="block text-sm font-medium text-gray-700 mb-1">
                  Art des Transports *
                </label>
                <select
                  id="transport-type"
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <div>
                  <label htmlFor="transport-from" className="block text-sm font-medium text-gray-700 mb-1">
                    Abholadresse *
                  </label>
                  <input
                    type="text"
                ...
                <div>
                  <label htmlFor="transport-to" className="block text-sm font-medium text-gray-700 mb-1">
                    Lieferadresse *
                  </label>
                  <input
                    type="text"
              ...
              <div>
                <label htmlFor="transport-date" className="block text-sm font-medium text-gray-700 mb-1">
                  Wunschtermin
                </label>
                <input
                  type="date"
              ...
              <div>
                <label htmlFor="transport-description" className="block text-sm font-medium text-gray-700 mb-1">
                ...
                <textarea
                  ...
                  style={{ outlineColor: primaryColor }}
                  placeholder="Beschreiben Sie die zu transportierenden Gegenstände..."
                />
              </div>
